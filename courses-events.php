...
<html class="no-js" lang="en">
  <head>
    ...
    <title>BERG Membership Program - Courses & Events</title>
  ...
  <body class="vs-body">
	...
	******************************** -->
    ...
    <?php require __DIR__ . '/header-en.php'; ?>
      ...
      <section
        class="vs-breadcrumb"
        data-bg-src="./assets/img/berg-membership-courses-events.png"
      >
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <div class="breadcrumb-content">
                <h1 class="breadcrumb-title">Courses & Events</h1>
              </div>
              <div class="breadcrumb-content">
    ...
    <div class="container">
        ...
        <div class="col-lg-auto mx-auto">
            ...
            <p class="sec-text mt-2 mb-0">
                Access to courses, seminars, and events.
            </p>
            </div>
        </div>
        </div>
        ...
        <div class="col-12">
            <p class="mb-0">
            BERG members receive a <strong>20% discount</strong> on the following courses and trainings:
            </p>
        </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <div class="benefit-card__top">
                ...
                loading="lazy"
                />
                <span class="benefit-card__badge">20% OFF</span>
            </div>

            <h4 class="benefit-card__title">Winter High-Mountain Training</h4>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <h4 class="benefit-card__title">Safe Outdoor Stay Course</h4>
            <p class="benefit-card__desc">
            </p>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <h4 class="benefit-card__title">Introduction to Technical Terrain Movement</h4>
            <p class="benefit-card__desc">
            </p>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <div class="benefit-card__top">
                ...
                loading="lazy"
                />
                <span class="benefit-card__badge">30% OFF</span>
            </div>

            <h4 class="benefit-card__title">Beo Hiking Fest</h4>
            <p class="benefit-card__desc">
                BERG members receive a 30% discount on Beo Hiking Fest tickets.
            </p>

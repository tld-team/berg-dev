...
<html class="no-js" lang="en">
  <head>
    ...
    <title>BERG Membership Program - Gear, Rental & First Aid</title>
  ...
  <body class="vs-body">
	...
	******************************** -->
    ...
    <?php require __DIR__ . '/header-en.php'; ?>
      ...
      <section
        class="vs-breadcrumb"
        data-bg-src="./assets/img/berg-membership-gear-rental-first-aid.png"
      >
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <div class="breadcrumb-content">
                <h1 class="breadcrumb-title">Gear, Rental & First Aid</h1>
              </div>
              <div class="breadcrumb-content">
    ...
    <div class="container">
        ...
        <div class="col-lg-auto mx-auto">
            ...
            <p class="sec-text mt-2 mb-0">
                Member savings in stores, rentals, and first aid kits.
            </p>
            </div>
        </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <p class="benefit-card__desc">
                BERG members get 30% off hiking and winter equipment rentals for each individual rental.
            </p>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <p class="benefit-card__desc">
                BERG members get 10% off the full assortment in the Tigil store.
            </p>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <h4 class="benefit-card__title">Aron Explorer – first aid kit</h4>
            <p class="benefit-card__desc">
                BERG members get 20% off an Aron Explorer first aid kit.
            </p>

...
<html class="no-js" lang="sr">
  <head>
    ...
    <title>BERG Membership Program - Benefiti</title>

    <meta name="description" content="BERG Membership Program - Benefiti" />
    <meta name="keywords" content="BERG Membership Program, benefiti, spasavanje, osiguranje, popusti" />
  ...
  <body class="vs-body">
    ...
    <main class="main">
      ...
      <section class="vs-breadcrumb" data-bg-src="./assets/img/berg-membership-benefits.png">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <div class="breadcrumb-content">
                <h1 class="breadcrumb-title">Benefiti</h1>
              </div>
      ...
      <section class="vs-activities space berg-benefits-tabs" id="benefits-tabs" style="background-color: #fdf8f5" >
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-10">
              <div class="title-area text-center">
                <span class="sec-subtitle">BENEFITI</span>
                <h2 class="sec-title">Šta dobijaš uz BERG članstvo</h2>
                <p class="sec-text mb-0">Klikni na benefit da odeš na detalje ispod.</p>
              </div>
            </div>
          </div>
          ...
          <div class="row gx-3 gy-3">
            ...
            <div class="col-md-6 col-lg-12">
              <div class="activities-box benefit-tile" data-href="#rescue-protection" role="link" tabindex="0">
                <figure class="activities-thumb">
                  <img
                    src="./assets/img/berg-membership-worldwide-rescue-protection.png"
                    alt="Zaštita spasavanja širom sveta"
                    class="w-100"
                  />

                  <figcaption class="activities-content">
                    <h5 class="title mb-0">Zaštita spasavanja širom sveta</h5>

                    <span class="info" style="color: white">
                      Zaštita za slobodno vreme, nezgode i međunarodna putovanja širom sveta,
                      uključena u svako članstvo (do 6.000 m).
                    </span>

                    <span class="benefit-tile-cta">
                      <a href="#rescue-protection" class="vs-btn style4">POGLEDAJ DETALJE</a>
                    </span>
                  </figcaption>
                </figure>
              </div>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="activities-box benefit-tile" data-href="#gear-rental-first-aid" role="link" tabindex="0">
                <figure class="activities-thumb">
                  <img
                    src="./assets/img/berg-membership-gear-rental-first-aid.png"
                    alt="Oprema, rentiranje i prva pomoć"
                    class="w-100"
                  />

                  <figcaption class="activities-content">
                    <h5 class="title mb-0">Oprema, rentiranje i prva pomoć</h5>

                    <span class="info" style="color: white;">Uštede za članove u radnjama, rentiranju i kompletima prve pomoći.</span>

                    <span class="benefit-tile-cta">
                      <a href="oprema-rentiranje-prva-pomoc.php" class="vs-btn style4">POGLEDAJ DETALJE</a>
                    </span>
                  </figcaption>
                </figure>
              </div>
            ...
            <!-- TAB 3 -->
            <div class="col-md-6 col-lg-3">
              <div class="activities-box benefit-tile" data-href="#tours-experiences" role="link" tabindex="0">
                <figure class="activities-thumb">
                  <img
                  ...
                  <figcaption class="activities-content">
                    <h5 class="title mb-0">Ture i iskustva</h5>

                    <span class="info" style="color: white;">Popusti na ture i smeštaj.</span>

                    <span class="benefit-tile-cta">
                      <a href="ture-iskustva.php" class="vs-btn style4">POGLEDAJ DETALJE</a>
                    </span>
                  </figcaption>
                </figure>
              </div>
            ...
            <!-- TAB 4 -->
            <div class="col-md-6 col-lg-3">
              <div class="activities-box benefit-tile" data-href="#courses-events" role="link" tabindex="0">
                <figure class="activities-thumb">
                  <img
                    src="./assets/img/berg-membership-courses-events.png"
                    alt="Kursevi i događaji"
                    class="w-100"
                  />

                  <figcaption class="activities-content">
                    <h5 class="title mb-0">Kursevi i događaji</h5>

                    <span class="info" style="color: white;">Pristup kursevima, seminarima i događajima.</span>

                    <span class="benefit-tile-cta">
                      <a href="kursevi-dogadjaji.php" class="vs-btn style4">POGLEDAJ DETALJE</a>
                    </span>
                  </figcaption>
                </figure>
              </div>
            ...
            <!-- TAB 5 -->
            <div class="col-md-6 col-lg-3">
              <div class="activities-box benefit-tile" data-href="#health-custom-upgrades" role="link" tabindex="0">
                <figure class="activities-thumb">
                  <img
                    src="./assets/img/berg-membership-health-custom-upgrades.png"
                    alt="Zdravlje i dodatne opcije"
                    class="w-100"
                  />

                  <figcaption class="activities-content">
                    <h5 class="title mb-0">Zdravlje i dodatne opcije</h5>

                    <span class="info" style="color: white;">
                      Uštede na sistematskim pregledima i opcioni dodaci. <em>Benefiti variraju po planu.</em>
                    </span>

                    <span class="benefit-tile-cta">
                      <a href="zdravlje-dodatne-opcije.php" class="vs-btn style4">POGLEDAJ DETALJE</a>
                    </span>
                  </figcaption>
                </figure>
              </div>

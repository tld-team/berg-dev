...
<html class="no-js" lang="sr">
  <head>
    ...
    <title>BERG Membership Program - Kursevi & Događaji</title>
  ...
  <body class="vs-body">
    ...
    <main class="main">
      ...
      <section class="vs-breadcrumb" data-bg-src="./assets/img/berg-membership-courses-events.png">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <div class="breadcrumb-content">
                <h1 class="breadcrumb-title">Kursevi & Događaji</h1>
              </div>
      ...
      <!--================= Benefits: Courses & Events start =================-->
        <section class="vs-about position-relative space" style="background-color:#fdf8f5" id="benefits-courses">
        <div class="container">
            <!-- Title -->
            <div class="row">
            <div class="col-lg-auto mx-auto">
                ...
                <p class="sec-text mt-2 mb-0">
                    Pristup kursevima, seminarima i događajima.
                </p>
                </div>
            </div>
            </div>

            <!-- Intro sentence above course list -->
            <div class="row mt-4">
            <div class="col-12">
                <p class="mb-0">
                Članovi BERG programa ostvaruju <strong>20% popusta</strong> na sledeće kurseve i obuke:
                </p>
            </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <article class="benefit-card" data-benefit-card data-card-type="course">
                ...
                <h4 class="benefit-card__title">Obuka zimskog visokogorstva</h4>
                <p class="benefit-card__desc">
                    Placeholder opis kursa (1–2 rečenice). Ovde ide kratak opis koji će kasnije biti ažuriran stvarnim sadržajem.
                </p>

                <a
                    class="vs-btn style4 benefit-card__cta"
                    href="https://montanaro.rs/avantura/obuka-zimskog-visokogorstva/"
                    target="_blank"
                    rel="noopener"
                >
                    <span>POGLEDAJ KURS</span>
                </a>
                </article>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <h4 class="benefit-card__title">Kurs bezbednog boravka u prirodi</h4>
                <p class="benefit-card__desc">
                    Placeholder opis kursa (1–2 rečenice). Ovde ide kratak opis koji će kasnije biti ažuriran stvarnim sadržajem.
                </p>
                ...
                <a
                    class="vs-btn style4 benefit-card__cta"
                    href="https://montanaro.rs/avantura/kurs-bezbednog-boravka-u-prirodi/"
                    target="_blank"
                    rel="noopener"
                >
                    <span>POGLEDAJ KURS</span>
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <h4 class="benefit-card__title">Uvod u kretanje po tehničkim terenima</h4>
                <p class="benefit-card__desc">
                    Placeholder opis kursa (1–2 rečenice). Ovde ide kratak opis koji će kasnije biti ažuriran stvarnim sadržajem.
                </p>
                ...
                <a
                    class="vs-btn style4 benefit-card__cta"
                    href="https://montanaro.rs/avantura/uvod-u-kretanje-po-tehnickim-terenima/"
                    target="_blank"
                    rel="noopener"
                >
                    <span>POGLEDAJ KURS</span>
            ...
            <!-- Events: Beo Hiking Fest -->
            <div class="row mt-5 g-4">
            <div class="col-md-6 col-lg-4">
                <article class="benefit-card" data-benefit-card data-card-type="event">
                <div class="benefit-card__top">
                    <img
                    class="benefit-card__logo"
                    src="./assets/img/benefits/berg-membership-beohiking-fest.png"
                    alt="Beo Hiking Fest"
                    loading="lazy"
                    />
                ...
                <h4 class="benefit-card__title">Beo Hiking Fest</h4>
                <p class="benefit-card__desc">
                    Članovi BERG programa ostvaruju 30% popusta na ulaznice za Beo Hiking Fest.
                </p>

                <a
                    class="vs-btn style4 benefit-card__cta"
                    href="https://beohikingfest.com/"
                    target="_blank"
                    rel="noopener"
                >
                    <span>POGLEDAJ DOGAĐAJ</span>
                </a>
                </article>
            </div>
            </div>
